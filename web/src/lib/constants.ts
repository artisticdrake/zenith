...
export const STATUS_CONFIG: Record<string, { color: string; bg: string; border: string }> = {
  ...
  "Interview Scheduled": { color: "text-violet-400", bg: "bg-violet-500/10", border: "border-violet-500/30" },
  "Interview Completed": { color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/30" },
